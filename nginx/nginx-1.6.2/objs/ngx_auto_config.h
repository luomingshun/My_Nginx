#define NGX_CONFIGURE " --prefix=/usr/local/webserver/nginx --with-http_stub_status_module --with-http_ssl_module --with-pcre=/usr/local/src/pcre-8.35"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/webserver/nginx/"
#endif
